...
const Office = () => {
	return (
		<section className="office">
			...
			<div className="office-holders">
				<div className="holder chairman">
					<img
						src="https://avatar.iran.liara.run/public/boy"
						alt="chair-image"
					/>
					<h2 className="chairman-header holder-header">Kevin Sialenga</h2>
					<p className="chairman-title holder-title">Chairman</p>
				</div>
